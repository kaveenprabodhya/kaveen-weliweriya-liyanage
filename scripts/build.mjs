...
export async function build({ root = process.cwd(), output = path.join(root, 'dist'), today = new Date().toISOString().slice(0, 10), branch = process.env.CF_PAGES_BRANCH || process.env.WORKERS_CI_BRANCH } = {}) {
